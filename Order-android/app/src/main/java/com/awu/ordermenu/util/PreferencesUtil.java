...
import com.awu.ordermenu.activity.app.OrderApplication;
...
public class PreferencesUtil {
    ...
    public static void setData(String key,Object value){
        setData(OrderApplication.AppContext(), key, value);
    }
    ...
    public static Object getData(String key,Object defaultValue){
        return  getData(OrderApplication.AppContext(),key,defaultValue);
    }
}
